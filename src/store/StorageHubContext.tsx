    ...
    try {
      ...
      if (saved) {
        ...
        return {
          ...
          payments: RECEIPT_CONFIRMATION_DEMO_PAYMENTS.reduce((items, sample) => mergeReceiptConfirmationDemo(items, sample), Array.isArray(parsed.payments) ? parsed.payments.filter((payment: StoragePayment) => !['RSV-6618', 'RSV-2104'].includes(payment.reservationId)) : []),
          ...
          checkins: reconcileReservationCheckins(normalizedHolds, mergeReceiptConfirmationDemo(Array.isArray(parsed.checkins) ? parsed.checkins : INITIAL_CHECKINS, RECEIPT_CONFIRMATION_DEMO_CHECKIN)),
          rentals: mergeReceiptConfirmationDemo(Array.isArray(parsed.rentals) ? mergeRenewalTestRentals(parsed.rentals) : INITIAL_RENTALS, RECEIPT_CONFIRMATION_DEMO_RENTAL),
