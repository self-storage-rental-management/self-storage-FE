    ...
    <AuthShell>
      <section className="hidden flex-col bg-[#292a27] p-10 text-white md:flex">
        ...
        <ul className="flex list-none flex-col gap-3 p-0">
          {[
            lang === 'vi' ? 'Kiểm tra phòng trống theo thời gian thực' : 'Real-time unit availability',
...
function StatusIcon() {
  return <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-emerald-100 text-2xl font-bold text-emerald-700">✓</span>
}

function Eye({ open }: { open: boolean }) {
  return open
    ? <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></svg>
    : <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="m3 3 18 18M10.6 10.6a2 2 0 0 0 2.8 2.8M9.9 5.2A10.7 10.7 0 0 1 12 5c6.5 0 10 7 10 7a18 18 0 0 1-3.1 4.3M6.3 6.3C3.7 8.2 2 12 2 12s3.5 7 10 7a9.8 9.8 0 0 0 3.1-.5"/></svg>
}
